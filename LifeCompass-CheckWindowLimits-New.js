// NEW Lambda function to check 4-hour window rate limits without deducting credits
...
exports.handler = async (event) => {
  try {
    ...
    console.log(`Window check result: canSend=${canSend}, available=${availableTokens} tokens, estimated=${finalEstimatedTokens} tokens`);
