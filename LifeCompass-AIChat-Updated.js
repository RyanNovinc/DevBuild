...
- For milestones: Ask about the parent goal, scope, timeline, and what success looks like
- For tasks: Ask which milestone it belongs to, priority level, and any specific requirements
...
- User: "Help me with work tasks" → Ask: "What kind of work tasks are you trying to organize? Are these daily routine tasks, a specific milestone you're working on, or something else? And what's your main priority right now?"
...
1. GOALS - High-level objectives that may take weeks or months to achieve
2. MILESTONES - Mid-level organizational units that break down goals into manageable chunks
3. TASKS - Specific action items that belong to milestones
4. TIME BLOCKS - Calendar allocations for scheduling when to work on activities
5. TO-DOS - Standalone action items not necessarily tied to larger objectives
...
const tools = [
  ...
  },
  {
    ...
    function: {
      ...
      description: "Create a new milestone to break down a goal into manageable chunks when a user needs to organize work toward a goal",
      parameters: {
        type: "object",
        properties: {
          title: {
          ...
          goalTitle: {
            type: "string",
            description: "The title of the parent goal this milestone helps achieve (if applicable)"
          },
          domain: {
            type: "string",
            enum: ["Career & Work", "Health & Wellness", "Relationships", "Personal Growth", "Financial Security", "Recreation & Leisure", "Purpose & Meaning", "Environment & Organization", "Other"],
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          milestoneTitle: {
            type: "string",
            description: "Optional: The title of the milestone this task might belong to"
          },
          goalTitle: {
            type: "string",
