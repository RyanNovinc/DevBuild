...
const AchievementsScreen = ({ navigation, route }) => {
  ...
  // State for expanded categories - initialize with first category expanded for better UX
  const [expandedCategories, setExpandedCategories] = useState({ strategic: true });
  ...
  const calculateStats = () => {
    try {
      ...
      // Check for stage up - Disable celebration for now to fix interaction blocking
      ...
      if (currentStage > previousStage && previousStage > 0) {
        ...
        // Trigger stage up celebration - DISABLED to fix interaction issues
        // setIsStagingUp(true);
        // setStageAnimationComplete(false);
        console.log(`Stage up detected: ${previousStage} -> ${currentStage}`);
      }
              ...
              <View style={{ flexDirection: 'column', width: '100%', marginBottom: 16 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: '100%', marginBottom: 8 }}>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      // Test Animation - DISABLED to fix interaction issues
                      console.log('Test animation button pressed (celebration disabled)');
                    }}
                    disabled={!stageAnimationComplete}
                  >
  ...
  // SIMPLIFIED TabBar for debugging
  const renderTabBar = (props) => {
    return (
      <View style={{ backgroundColor: theme.background, paddingHorizontal: 16, paddingVertical: 8 }}>
        {/* Back Button */}
        <TouchableOpacity 
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'center', marginTop: 10 }}>
          <TouchableOpacity
            style={{
              ...
              alignItems: 'center',
              paddingVertical: 10,
              backgroundColor: props.navigationState.index === 0 ? theme.primary : 'transparent',
              borderRadius: 8,
              marginRight: 8
            }}
          ...
          >
            <Text style={{ 
              color: props.navigationState.index === 0 ? 'white' : theme.text,
              fontWeight: '600' 
            }}>Progress</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            style={{
              ...
              alignItems: 'center',
              paddingVertical: 10,
              backgroundColor: props.navigationState.index === 1 ? theme.primary : 'transparent',
              borderRadius: 8,
              marginLeft: 8
            }}
          ...
          >
            <Text style={{ 
              color: props.navigationState.index === 1 ? 'white' : theme.text,
              fontWeight: '600' 
            }}>Achievements</Text>
          </TouchableOpacity>
        </View>
  ...
  return (
    ...
    >
      ...
      {/* TabView with Swipe Gestures - SIMPLIFIED FOR DEBUGGING */}
      <TabView
